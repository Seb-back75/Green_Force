...
--
-- Hôte : 127.0.0.1
-- Généré le :  Dim 19 jan. 2020 à 14:22
...
(2, 'Corbeille à papier carré', 'Corbeille à papier carré en bois style bambou. Capacité de 30L', 'pt20432321-professional_grade_bamboo_utensil_set_eco_friendly_with_ergonomic_handle.jpg', 20, 354, 20, 10, ''),
...
INSERT INTO `login` (`id`, `email`, `mdp`) VALUES
(1, 'sdf@dsf.fr', 'dsfd'),
(2, 'caca@caca.fr', 'caca');
